...
export const getPlants = ({ user_id }) => {
  return dispatch => {
    return fetch(`https://plant-nexus.herokuapp.com/api/v1/users/${user_id}/plants`, {
      credentials: 'include',
      method: 'GET',
      headers: {
...
export const createPlant = (formData, history) => {
  return dispatch => {
    ...
    return fetch("https://plant-nexus.herokuapp.com/api/v1/plants", {
      credentials: 'include',
      method: 'POST',
      headers: {
        "Content-Type": "application/json"
...
export const updatePlant = (formData, history) => {
  return dispatch => {
    ...
    return fetch(`https://plant-nexus.herokuapp.com/api/v1/plants/${formData.plantId}`, {
      credentials: 'include',
      method: 'PATCH',
...
export const deletePlant = (plantId, history) => {
  return dispatch => {
    return fetch(`https://plant-nexus.herokuapp.com/api/v1/plants/${plantId}`, {
      credentials: "include",
      method: "DELETE",
      headers: {"Content-Type": "application/json"}
    })
